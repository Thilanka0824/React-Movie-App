  ...
  return (
    <div className="input-boxes">
      ...
      <button
        ...
        onClick={() => {
          const imagesArr = [];
          const info = { title, director, actors, plot, comingSoon, year, rated, released, runtime, genre, writer, language, country, awards, imdbRating, type, image }
          handleAddMovie(info);
